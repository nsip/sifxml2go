package sifxml
    ...
    type StudentAttendanceCollections struct {
      studentattendancecollections `json:"StudentAttendanceCollections"`
    }

    type studentattendancecollections struct {
      StudentAttendanceCollection []studentattendancecollection `json:"StudentAttendanceCollection"`
    }
