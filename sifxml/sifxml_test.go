...
func Test_test_example0727(t *testing.T) {
        a := Identity{}
        err := xml.Unmarshal([]byte(test_example0727), &a)
        errcheck(t, err)
        output, err := xml.Marshal(a)
        errcheck(t, err)
        want, err := mxj.NewMapXml(stripEmptyTags([]byte(test_example0727)))
        errcheck(t, err)
        mv, err := mxj.NewMapXml(stripEmptyTags(output))
        errcheck(t, err)
        if !reflect.DeepEqual(mv, want) {
                t.Fatalf("test_example0727 not DeepEqual:\nmv  : %+v\nwant: %+v\n%s\n%s\n", mv, want, string(stripEmptyTags([]byte(test_example0727))), string(stripEmptyTags(output)))
        }
}
...
func Test_test_PersonPrivacyObligationDocument(t *testing.T) {
        a := PersonPrivacyObligationDocument{}
        err := xml.Unmarshal([]byte(test_PersonPrivacyObligationDocument), &a)
        errcheck(t, err)
        output, err := xml.Marshal(a)
        errcheck(t, err)
        want, err := mxj.NewMapXml(stripEmptyTags([]byte(test_PersonPrivacyObligationDocument)))
        errcheck(t, err)
        mv, err := mxj.NewMapXml(stripEmptyTags(output))
        errcheck(t, err)
        if !reflect.DeepEqual(mv, want) {
                t.Fatalf("test_PersonPrivacyObligationDocument not DeepEqual:\nmv  : %+v\nwant: %+v\n%s\n%s\n", mv, want, string(stripEmptyTags([]byte(test_PersonPrivacyObligationDocument))), string(stripEmptyTags(output)))
        }
}
...
func Test_test_SchoolInfoEarlyChildhood(t *testing.T) {
        a := SchoolInfo{}
        err := xml.Unmarshal([]byte(test_SchoolInfoEarlyChildhood), &a)
        errcheck(t, err)
        output, err := xml.Marshal(a)
        errcheck(t, err)
        want, err := mxj.NewMapXml(stripEmptyTags([]byte(test_SchoolInfoEarlyChildhood)))
        errcheck(t, err)
        mv, err := mxj.NewMapXml(stripEmptyTags(output))
        errcheck(t, err)
        if !reflect.DeepEqual(mv, want) {
                t.Fatalf("test_SchoolInfoEarlyChildhood not DeepEqual:\nmv  : %+v\nwant: %+v\n%s\n%s\n", mv, want, string(stripEmptyTags([]byte(test_SchoolInfoEarlyChildhood))), string(stripEmptyTags(output)))
        }
}
...
func Test_test_example0689(t *testing.T) {
        a := StudentPersonal{}
        err := xml.Unmarshal([]byte(test_example0689), &a)
        errcheck(t, err)
        output, err := xml.Marshal(a)
        errcheck(t, err)
        want, err := mxj.NewMapXml(stripEmptyTags([]byte(test_example0689)))
        errcheck(t, err)
        mv, err := mxj.NewMapXml(stripEmptyTags(output))
        errcheck(t, err)
        if !reflect.DeepEqual(mv, want) {
                t.Fatalf("test_example0689 not DeepEqual:\nmv  : %+v\nwant: %+v\n%s\n%s\n", mv, want, string(stripEmptyTags([]byte(test_example0689))), string(stripEmptyTags(output)))
        }
}
...
func Test_test_CollectionAcquittal(t *testing.T) {
        a := CollectionAcquittal{}
        err := xml.Unmarshal([]byte(test_CollectionAcquittal), &a)
        errcheck(t, err)
        output, err := xml.Marshal(a)
        errcheck(t, err)
        want, err := mxj.NewMapXml(stripEmptyTags([]byte(test_CollectionAcquittal)))
        errcheck(t, err)
        mv, err := mxj.NewMapXml(stripEmptyTags(output))
        errcheck(t, err)
        if !reflect.DeepEqual(mv, want) {
                t.Fatalf("test_CollectionAcquittal not DeepEqual:\nmv  : %+v\nwant: %+v\n%s\n%s\n", mv, want, string(stripEmptyTags([]byte(test_CollectionAcquittal))), string(stripEmptyTags(output)))
        }
}
func Test_test_CollectionDeclaration(t *testing.T) {
        a := CollectionDeclaration{}
        err := xml.Unmarshal([]byte(test_CollectionDeclaration), &a)
        errcheck(t, err)
        output, err := xml.Marshal(a)
        errcheck(t, err)
        want, err := mxj.NewMapXml(stripEmptyTags([]byte(test_CollectionDeclaration)))
        errcheck(t, err)
        mv, err := mxj.NewMapXml(stripEmptyTags(output))
        errcheck(t, err)
        if !reflect.DeepEqual(mv, want) {
                t.Fatalf("test_CollectionDeclaration not DeepEqual:\nmv  : %+v\nwant: %+v\n%s\n%s\n", mv, want, string(stripEmptyTags([]byte(test_CollectionDeclaration))), string(stripEmptyTags(output)))
        }
}
...
func Test_test_example0115(t *testing.T) {
        a := PurchaseOrder{}
        err := xml.Unmarshal([]byte(test_example0115), &a)
        errcheck(t, err)
        output, err := xml.Marshal(a)
        errcheck(t, err)
        want, err := mxj.NewMapXml(stripEmptyTags([]byte(test_example0115)))
        errcheck(t, err)
        mv, err := mxj.NewMapXml(stripEmptyTags(output))
        errcheck(t, err)
        if !reflect.DeepEqual(mv, want) {
                t.Fatalf("test_example0115 not DeepEqual:\nmv  : %+v\nwant: %+v\n%s\n%s\n", mv, want, string(stripEmptyTags([]byte(test_example0115))), string(stripEmptyTags(output)))
        }
}
...
func Test_test_StudentDataTransferNoteExample(t *testing.T) {
        a := StudentDataTransferNote{}
        err := xml.Unmarshal([]byte(test_StudentDataTransferNoteExample), &a)
        errcheck(t, err)
        output, err := xml.Marshal(a)
        errcheck(t, err)
        want, err := mxj.NewMapXml(stripEmptyTags([]byte(test_StudentDataTransferNoteExample)))
        errcheck(t, err)
        mv, err := mxj.NewMapXml(stripEmptyTags(output))
        errcheck(t, err)
        if !reflect.DeepEqual(mv, want) {
                t.Fatalf("test_StudentDataTransferNoteExample not DeepEqual:\nmv  : %+v\nwant: %+v\n%s\n%s\n", mv, want, string(stripEmptyTags([]byte(test_StudentDataTransferNoteExample))), string(stripEmptyTags(output)))
        }
}
