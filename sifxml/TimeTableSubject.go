...
type TimeTableSubjects []TimeTableSubject
    ...
    type TimeTableSubject struct {
      ...
      ProposedMaxClassSize float64 `default:"-2147483648" xml:"ProposedMaxClassSize" json:"ProposedMaxClassSize"`
      ProposedMinClassSize float64 `default:"-2147483648" xml:"ProposedMinClassSize" json:"ProposedMinClassSize"`
