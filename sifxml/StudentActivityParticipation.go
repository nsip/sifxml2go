package sifxml
    ...
    type StudentActivityParticipations struct {
      studentactivityparticipations `json:"StudentActivityParticipations"`
    }

    type studentactivityparticipations struct {
      StudentActivityParticipation []studentactivityparticipation `json:"StudentActivityParticipation"`
    }
